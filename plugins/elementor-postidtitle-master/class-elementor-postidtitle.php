...
/**
 * Main Elementor Postidtitle Class
 *
 * The init class that runs the Elementor Postidtitle plugin.
 ...
 */
final class Elementor_Postidtitle {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-postidtitle' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_POSTIDTITLE ) );
...
// Instantiate Elementor_Postidtitle.
new Elementor_Postidtitle();
